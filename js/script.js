    ...
    mainArr.map(item => {
        if (isInViewport(item)) {
            if (item.dataset.view) {
                ...
                if (pluginName === "counterdown") {
                    let counterNumber = Number(item.innerHTML);
                    let countstartPoint = counterNumber;
                    ...
                    function progressbar() {
                        ...
                        item.style.width = `${ 100- barStartPoint}%`
        ...
        if (isInViewport(item)) {
            ...
            if (item.dataset.view) {
                ...
                if (pluginName === "counterdown") {
                    ...
                    function typejs() {
                        if (countstartPoint < typeText.length - 1) {
                            countstartPoint++;
                            item.innerHTML += typeText.charAt(countstartPoint)
                             typeArr = item.innerHTML.split("")
                        } else {
